"""CLI to run perception pipeline test."""
...
app = typer.Typer(help="Run perception pipeline test.")
console = Console()
...
def main(
    ...
    console.print(Panel("[bold green]ONS Sentinel Core — Perception Test[/bold green]"))
    ...
    if cfg.recorder.enabled:
        ...
        console.print(f"  metrics: {run_dir / 'perception_metrics.json'}")

    console.print(Panel("[bold green]Perception test complete.[/bold green]"))
